...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  7 10:30:56 2023
...
q = pd.read_csv('save_dir/data/20230607_012.csv', delimiter=';', decimal=',', keep_default_na = False)
...
d = pd.read_csv('save_dir/data/20230607_009.csv', delimiter=';', decimal=',', keep_default_na = False)
...
ax = axes[0]
ax.plot(func(LOBH, 24, 0), label='Lobith')
#ax.set_xlim(0,150)
ax.set_xlabel('day from 01-01-2013')
ax.set_ylabel('$Q$')
ax.legend()
