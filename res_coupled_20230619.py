...
varspace = np.array([kappa/10, kappa/4, kappa/2, kappa, kappa*2])  
...
ax.set_ylabel(r'$t$ (s)')
ax.set_title('decreasing salinity')
...
ax.legend(handles=c_patches+[dt_line, dt2_line, dt3_line])
...
ax.set_xlabel(r'$-x & r$ (m)')
ax.set_ylabel(r'$t$ (s)')
ax.set_title('increasing salinity')
